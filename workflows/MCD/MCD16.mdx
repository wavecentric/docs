...
sidebarTitle: "MCD 16"
description: "Generate railway graphs from Zig Zag"
---

## 1. Overview

**Generation of Railway Graphs** empowers users to dynamically model logistics networks. It fulfills the requirement that "the Multimodal Chain Design module will have to offer the possibility of being able to generate railway graphs starting from Zig Zag that will allow users to run simulations and evaluate different 'what-if' scenarios, based on different logistics options."
...
### Zig Zag
**Requirement Addressed**: *"Generate railway graphs starting from Zig Zag"*
...
| :--- | :--- |
| **Graph Generation** | **Evidenced by [Zig Zag Tool]**: The interface (shown in *zigzag1.png*) explicitly provides the tooling to configure and generate new railway graph segments from Zig Zag. |
