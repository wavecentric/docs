...
<img src="/images/magemo/fleet/flotta-carri.png" alt="Flotta Carri - Real-time Wagon Fleet Map Dashboard" />
...
- <div className="flex items-center gap-2"><div className="w-3 h-3 rounded-full bg-blue-500"></div> **in movimento**: Wagons currently in transit (Nexxiot detection).</div>
- <div className="flex items-center gap-2"><div className="w-3 h-3 rounded-full bg-gray-500"></div> **in piedi**: Wagons currently stationary at a node.</div>
- <div className="flex items-center gap-2"><div className="w-3 h-3 rounded-full bg-green-500"></div> **tutto**: The total tracked inventory.</div>
